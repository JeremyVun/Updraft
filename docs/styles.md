...
"Painted golden hour": a small island in warm late-afternoon light, drawn with soft painterly shading, where the wind is the most visible thing on screen.
...
- **Wind is visible everywhere**: grass bends in travelling waves, and flattened grass turns paler and shinier, so gusts read as bright streaks across the field. Petals lift in bursts. The sea roughens into darker patches under gusts. Cloud shadows drift across the island with the breeze.
...
- **Sea**: turquoise over sand in the shallows, deep blue further out, soft foam where waves meet the beach, sky reflections that strengthen toward the horizon.
