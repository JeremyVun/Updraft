...
export type Cue = 'breeze' | 'delight' | 'restored' | 'overhead' | 'skein' | 'fallen' | 'landed' | 'kindled' | 'distress' | 'calling' | 'bugle' | 'becalmed' | 'filled' | 'lifted' | 'wave' | 'unfold' | 'release' | 'home' | 'finale';
