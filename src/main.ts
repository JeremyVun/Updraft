...
if (params.shot) {
  window.__game = { wind, input, rig, renderer, scene, glider, lines, sound, child, story, creatures, hillCreatures, water, terrain, cottage, petals, grass, sealife, crane, flock, washing, kite, pinwheels, village, wood, embers, boat, life, piano, birches };
}
