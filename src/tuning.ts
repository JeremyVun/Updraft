...
export const tuning = {
  ...
  storm: {
    ...
    planeLookUp: 1.8,
    planeLookFor: 2,
    /** The storm carries the plane off faster than the boat sails; it is put away once it is out of frame or the
        rain has swallowed it (this many fog lengths deep), and whatever happens by the fallback. */
    planeAwaySpeed: 13,
    planeLostInFog: 3,
    planeLostAfter: 30,
    firstLightning: 16,
